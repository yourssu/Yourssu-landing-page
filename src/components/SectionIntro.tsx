...
function SectionIntro({ title, description, divStyle, color }: IntroElement) {
  return (
    <div className="flex flex-col items-center mx-[50px]">
      ...
      <h1 className="xs:mt-[15px] mt-[40px] mb-[10px] font-Jost font-medium xl:font-semibold xxl:font-semibold xs:text-[20px] sm:text-[24px] md:text-[32px] text-[36px] tracking-[.01em]">
        {title}
      </h1>
