      ...
      <div className="relative flex flex-col items-start justify-center xs:mb-[5px] sm:mb-[5px] md:mb-[10px]">
        ...
        <div className="flex flex-col px-[50px] xs:px-[32px] sm:px-[10px]">
          ...
          {currentIndex === 1 || currentIndex === 3 || currentIndex === 4 ? (
            <div className="mt-[35px] flex h-[80px] flex-col justify-between xs:hidden sm:hidden md:hidden">
            ...
            <div className="mt-[35px] flex h-[132px] flex-col justify-between xs:hidden sm:hidden md:hidden">
              {projectData[currentIndex].list.map((listData) => {
                return (
                  // eslint-disable-next-line react/jsx-key
                  <div
