  ...
  return (
    <div className="relative flex flex-col justify-center items-center">
      ...
      <div className=" flex flex-col justify-center items-center w-full absolute top-[132px] xxl:hidden xl:hidden lg:hidden">
        ...
        <span className=" font-Jost font-semibold md:text-[48px] sm:text-[40px] md:leading-[48px] sm:leading-[40px] -tracking-[2%] md:mt-[11px] sm:mt-[7px]">
          YOURSSU
        </span>
      </div>
      {/* 1080, 1440, 1920 화면 */}
      <div className="flex justify-start xxl:min-w-[1280px] xl:min-w-[1160px] lg:min-w-[870px] top-[330px] lg:top-[278px] absolute sm:hidden md:hidden">
        <div className=" flex flex-col items-start ">
          ...
          <span className=" font-Jost font-bold lg:font-semibold xxl:text-[90px] xl:text-[86px] lg:text-[68px] xxl:leading-[90px] xl:leading-[96px] lg:leading-[68px] -tracking-[2%] xxl:mt-[15px] xl:mt-[12px] lg:mt-[10px]">
            YOURSSU
          </span>
        </div>
      </div>
