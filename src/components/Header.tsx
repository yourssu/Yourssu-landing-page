...
export default function Header() {
  ...
  return (
    <header className="flex flex-col justify-between items-center w-full xxl:px-[320px] xl:px-[140px] lg:px-[105px] top-[37px] md:px-[70px] md:top-[24px] sm:px-[17px] sm:top-[15px] absolute z-10">
      <div className="flex flex-row justify-between items-center xxl:w-[1280px] xl:w-[1160px] lg:w-[870px] md:w-[580px] sm:w-[355px]">
        <div className="flex flex-row justify-start items-center">
          ...
          />
          <span className="font-bold text-[24px] md:text-[20] sm:text-[16px] -tracking-[1%]">
            YOURSSU
          </span>
        </div>
      ...
      <hr className=" xxl:w-[1280px] xl:w-[1160px] lg:w-[870px] md:w-[580px] sm:w-[355px] h-0.5 bg-[#8F8F90] block mt-1" />
    </header>
  );
}
