  ...
  const faqs = [
    {
      ...
      answer: '필수 활동 기간은 1년이며, 이후에도 계속 활동할 수 있어요.',
    },
    {
      question: '두 개 이상의 파트를 중복 지원할 수 있나요?',
      answer:
        '아니요. 하나의 파트만 선택해 지원해야 해요. 중복 지원 시 불이익이 있을 수 있으니 신중하게 선택해주세요!',
    },
    {
    ...
    },
    {
      ...
      answer: '일부 파트는 코딩 테스트 혹은 과제를 진행해요.',
    },
    {
