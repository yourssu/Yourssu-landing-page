...
export default function DepartmentSearch({
  ...
  return (
    <div className="flex h-auto w-[1280px] justify-between rounded-[14px] bg-bluegray3-0 px-[32px] py-[17px] xs:w-[200px] sm:w-[200px] md:w-[500px] lg:w-[924px]">
      <input
        ref={Ref}
        className=" font-Pretendard w-[800px] border-none bg-bluegray3-0 text-[24px] font-[600] leading-[28.64px] text-bluegray1-0 outline-none xs:w-[100px] xs:text-[14px] xs:font-[400] xs:leading-[16.71px] sm:w-[100px] sm:text-[14px] sm:font-[400] sm:leading-[16.71px] md:w-[350px] lg:w-[600px]"
        placeholder={
          windowSize
